      ...
      try {
        ...
        const { error } = await supabase.from('orders').insert({
          ...
          configuracion: {
            ...
            envio: {
              nombre: meta.shipping_name || null,
              direccion: meta.shipping_line || null,
              ciudad: meta.shipping_city || null,
              cp: meta.shipping_postal || null,
              provincia: meta.shipping_province || null,
              pais: meta.shipping_country || null,
              telefono: meta.shipping_phone || null,
            },
          },
